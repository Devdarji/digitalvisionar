    ...
    <section id="about" className="py-20 bg-gray-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="relative animate-slideInLeft">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-emerald-500/20">
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-black/60 backdrop-blur-md p-6 rounded-2xl border border-emerald-500/30 animate-fadeInUp animation-delay-400">
          ...
          <div className="animate-slideInRight">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3 animate-fadeInUp animation-delay-200">
              ...
              <div className="flex items-start gap-3 animate-fadeInUp animation-delay-400">
              ...
              <div className="flex items-start gap-3 animate-fadeInUp animation-delay-600">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-gray-900 to-black border border-emerald-500/30 p-6 rounded-2xl text-center hover:border-emerald-500 transition transform hover:scale-105 shadow-lg shadow-emerald-500/10 animate-scaleIn animation-delay-200">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-purple-500/30 p-6 rounded-2xl text-center hover:border-purple-500 transition transform hover:scale-105 shadow-lg shadow-purple-500/10 animate-scaleIn animation-delay-400">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-blue-500/30 p-6 rounded-2xl text-center hover:border-blue-500 transition transform hover:scale-105 shadow-lg shadow-blue-500/10 animate-scaleIn animation-delay-600">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-pink-500/30 p-6 rounded-2xl text-center hover:border-pink-500 transition transform hover:scale-105 shadow-lg shadow-pink-500/10 animate-scaleIn animation-delay-800">
