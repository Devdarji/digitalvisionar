        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden md:block">
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <div className="relative bg-gradient-to-br from-gray-900 to-black p-8 rounded-3xl border border-emerald-500/30 shadow-2xl shadow-emerald-500/20">
                <div className="space-y-4">
                  <div className="flex items-center gap-4 bg-emerald-500/10 p-4 rounded-xl border border-emerald-500/30 transform hover:scale-105 transition">
                  ...
                  <div className="flex items-center gap-4 bg-purple-500/10 p-4 rounded-xl border border-purple-500/30 transform hover:scale-105 transition">
                  ...
                  <div className="flex items-center gap-4 bg-blue-500/10 p-4 rounded-xl border border-blue-500/30 transform hover:scale-105 transition">
                  ...
                  <div className="flex items-center gap-4 bg-pink-500/10 p-4 rounded-xl border border-pink-500/30 transform hover:scale-105 transition">
