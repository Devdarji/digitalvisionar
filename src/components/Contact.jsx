      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6 animate-slideInRight">
            <div className="flex items-start space-x-4 p-6 bg-gray-900 rounded-xl border border-gray-800 hover:border-emerald-500 transition transform hover:scale-105 animate-fadeInUp animation-delay-200">
            ...
            <div className="flex items-start space-x-4 p-6 bg-gray-900 rounded-xl border border-gray-800 hover:border-emerald-500 transition transform hover:scale-105 animate-fadeInUp animation-delay-400">
              <div className="w-12 h-12 bg-emerald-500/10 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-start space-x-4 p-6 bg-gray-900 rounded-xl border border-gray-800 hover:border-emerald-500 transition transform hover:scale-105 animate-fadeInUp animation-delay-600">
              <div className="w-12 h-12 bg-emerald-500/10 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
